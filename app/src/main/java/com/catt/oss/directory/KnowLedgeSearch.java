...
public class KnowLedgeSearch extends BaseActivity {
	...
	protected void initialSetup(BaseActivity context) {
		...
		TextViewEdit view1=new TextViewEdit(context, "000", null, dm);
		TextViewEdit view2=new TextViewEdit(context, "111", null, dm);
		TextViewEdit view3=new TextViewEdit(context, "222", null, dm);
		TextViewEdit view4=new TextViewEdit(context, "333", null, dm);
