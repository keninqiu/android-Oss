...
public class KnowledgeAddOrModify extends BaseActivity {
	...
	protected void initialSetup(BaseActivity context) {
		...
		if(addOrmodify.equals(Config.ADD)){
		     ...
		     view4=new TextViewEdit(this, "֪ʶ���","",dm);
		     view5=new TextViewEdit(this, "֪ʶ����","",dm);
		    ...
		    view4=new TextViewEdit(this, "֪ʶ���",listdata.get(3),dm);
		    view5=new TextViewEdit(this, "֪ʶ����",listdata.get(4),dm);
			...
			submit.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(addOrmodify.equals("add")){
						dialogShow(KnowledgeAddOrModify.this,"���","ȷ�������?");
